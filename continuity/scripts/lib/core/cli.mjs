...
function parse(argv) {
  ...
  const options = {
    ...
    next: null, blocked: false, kind: null, exitCode: null, run: null, assignee: null, evidence: null,
  ...
  while (args.length) {
    ...
    else if (value === '--run') { mark(value); options.run = takeValue('--run requires a value'); }
