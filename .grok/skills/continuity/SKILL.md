...
This file is a Grok Build discovery pointer. The canonical Skill is [`continuity/SKILL.md`](../../../continuity/SKILL.md). Invoke the CLIs from this checkout. Do not fork journal logic. Do not require any other Skill.
